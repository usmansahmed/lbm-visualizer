...
__global__ void writeVisualizationSliceKernel(LbmGridData fields, float *scalarOut, SliceOrientation orientation,
                                      DisplayField displayField, int sliceIndex, int planeWidth, int planeHeight, bool writeArrowSlice, bool automaticScaling)
{
...
void launchPrepareVisualizationSliceKernel(LbmGridData grid, float *mappedPixels,
                             ...
                             dim3 blocks, dim3 threads)
{
    ...
    writeVisualizationSliceKernel<<<blocks, threads, sharedMemorySize>>>(grid, mappedPixels, orientation, field, sliceIndex, planeWidth, planeHeight, writeArrowSlice, automaticScaling);
}